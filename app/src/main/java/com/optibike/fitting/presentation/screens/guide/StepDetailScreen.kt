    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    text = stringResource(id = when(step.id) {
                        1 -> R.string.step_1_tip
                        2 -> R.string.step_2_tip
                        3 -> R.string.step_3_tip
                        4 -> R.string.step_4_tip
                        5 -> R.string.step_5_tip
                        6 -> R.string.step_6_tip
                        7 -> R.string.step_7_tip
                        else -> step.shortDescriptionResId
                    }),
...
@Composable
private fun MeasurementChip(measurementType: com.optibike.fitting.domain.model.MeasurementType) {
    val measurementName = when (measurementType) {
        com.optibike.fitting.domain.model.MeasurementType.HEIGHT -> R.string.form_height
        com.optibike.fitting.domain.model.MeasurementType.INSEAM -> R.string.form_leg_length
        com.optibike.fitting.domain.model.MeasurementType.SHOULDER_WIDTH -> R.string.form_shoulder_width
        com.optibike.fitting.domain.model.MeasurementType.ARM_LENGTH -> R.string.form_arm_length
        com.optibike.fitting.domain.model.MeasurementType.TORSO_LENGTH -> R.string.form_torso_length
        com.optibike.fitting.domain.model.MeasurementType.BIKE_TYPE -> R.string.form_bike_type
        com.optibike.fitting.domain.model.MeasurementType.FRAME_SIZE -> R.string.form_frame_size
        com.optibike.fitting.domain.model.MeasurementType.SADDLE_HEIGHT -> R.string.form_saddle_height
        com.optibike.fitting.domain.model.MeasurementType.HANDLEBAR_HEIGHT -> R.string.form_handlebar_height
        com.optibike.fitting.domain.model.MeasurementType.CRANK_LENGTH -> R.string.form_crank_length
        com.optibike.fitting.domain.model.MeasurementType.SHOE_SIZE -> R.string.form_shoe_size
    }

package com.void.bikefitting.presentation.screens.settings
...
import com.void.bikefitting.presentation.viewmodel.SettingsViewModel
            ...
            thumbContent = {
                Icon(
                    imageVector = if (isDarkModeEnabled) {
                        androidx.compose.material.icons.Icons.Default.NightlightRound
                    } else {

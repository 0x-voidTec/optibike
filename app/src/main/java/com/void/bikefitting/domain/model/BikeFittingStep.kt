    ...
    fun getAllSteps(): List<BikeFittingStep> {
        return listOf(
            BikeFittingStep(
                ...
                titleResId = com.void.bikefitting.R.string.step_1_title,
                descriptionResId = com.void.bikefitting.R.string.step_1_description,
                shortDescriptionResId = com.void.bikefitting.R.string.step_1_short,
            ...
            BikeFittingStep(
                id = STEP_SADDLE_TILT,
                titleResId = com.void.bikefitting.R.string.step_2_title,
                descriptionResId = com.void.bikefitting.R.string.step_2_description,
                shortDescriptionResId = com.void.bikefitting.R.string.step_2_short,
                requiredMeasurements = listOf(MeasurementType.SADDLE_HEIGHT)
            ),
            BikeFittingStep(
                id = STEP_SADDLE_FORE_AFT,
                titleResId = com.void.bikefitting.R.string.step_3_title,
                descriptionResId = com.void.bikefitting.R.string.step_3_description,
                shortDescriptionResId = com.void.bikefitting.R.string.step_3_short,
                requiredMeasurements = listOf(
                    MeasurementType.HEIGHT,
                    MeasurementType.INSEAM,
                    MeasurementType.BIKE_TYPE
            ...
            BikeFittingStep(
                ...
                titleResId = com.void.bikefitting.R.string.step_4_title,
                descriptionResId = com.void.bikefitting.R.string.step_4_description,
                shortDescriptionResId = com.void.bikefitting.R.string.step_4_short,
                requiredMeasurements = listOf(
            ...
            BikeFittingStep(
                ...
                titleResId = com.void.bikefitting.R.string.step_5_title,
                descriptionResId = com.void.bikefitting.R.string.step_5_description,
                shortDescriptionResId = com.void.bikefitting.R.string.step_5_short,
                requiredMeasurements = listOf(
                    MeasurementType.HEIGHT,
                    MeasurementType.BIKE_TYPE
                )
            ...
            BikeFittingStep(
                ...
                titleResId = com.void.bikefitting.R.string.step_6_title,
                descriptionResId = com.void.bikefitting.R.string.step_6_description,
                shortDescriptionResId = com.void.bikefitting.R.string.step_6_short,
                requiredMeasurements = listOf(
            ...
            BikeFittingStep(
                ...
                titleResId = com.void.bikefitting.R.string.step_7_title,
                descriptionResId = com.void.bikefitting.R.string.step_7_description,
                shortDescriptionResId = com.void.bikefitting.R.string.step_7_short,
                requiredMeasurements = listOf(
